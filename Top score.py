...
def main():
    ...
    player_scores = [(f'Player {i}', random.randint(10000, 20000)) for i in range(1, 11)]

    # Sort scores in the range of 10000-20000
    player_scores[0] = ('Player 1', 20000)
    player_scores[-1] = ('Player 10', 10000)
